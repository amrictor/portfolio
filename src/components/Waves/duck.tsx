...
//   ctx.fill();
//   ctx.restore();
//   const imagePos = { x: dY/2, y: dY-120-wav }
  

  
//   ctx.drawImage(image, w / 2, dY-120);
...
//   // ctx.drawImage(image, 0 - wav, dY - wav, 300, 350);
// }
...
// export const Duck: React.FC = React.memo(() => {
...
// // import React, { useEffect, useRef } from 'react';
// // import duck from '../../assets/duck.svg'
// // import { addDuck } from './duck';
// // import { calcFlat, calcSpeed, calcWave } from './waves';
...
// // function drawDuck(ctx: CanvasRenderingContext2D, wav: number, dY: number, wDelta: number) {
// //   console.log(wav, dY, wDelta)
// //   const imagePos = { x: dY/2, y: dY-120-wav }
// //   const angleDelta = degreesToRadians(-0.25* wDelta);
// //   angle+=angleDelta
// //   ctx.save();
...
// //   // ctx.rotate(angle)
// //   // ctx.translate(-imagePos.x, -imagePos.y)
// //   // ctx.drawImage(image, imagePos.x, imagePos.y, 400, 450);
// //   ctx.restore()
// // }
...
// //   if (mW < canvas.width) mW = canvas.width;
// //   let ctx = canvas.getContext('2d',  {alpha: true})!;
// //   drawDuck(ctx, wave, canvas.height - canvas.height * rate, 0.25);
...
// //     if (rate !== rate1 || wave1 !== wave) {
// //       ctx.clearRect(0, 0, canvas.width, canvas.height) 
// //       drawDuck(ctx0, wave, canvas.height - canvas.height * rate, waveDelta);
// //     }
